...
class logistic_regression_classifier(object):
    ...
    def __init__(self, train_set=None, val_set=None, data_file=None, header=0,
                 test_size=0.2, feature_col_range=[0, 8], label_col=-1, features_degree=2,
    ...
    def fit(self, C=1, max_iter=10000, strategy='ovo', solver='liblinear'):

        # Fitting Decision Tree Classification to the Training set
        print('Fitting the train set...')

        estimator = LogisticRegression(C=C, solver=solver, max_iter=1000, verbose=0)
...
if __name__ == '__main__':
    ...
    classifier = logistic_regression_classifier(data_file='RD-RDT DATA ALL.csv',
                                                feature_col_range=[2, 9],
                                                test_size=0.2,
                                                features_degree=2)
    classifier.fit(strategy='ovr', solver='liblinear')
    # classifier.plot(2,5)
