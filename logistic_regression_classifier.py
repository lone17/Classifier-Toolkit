...
class logistic_regression_classifier(object):
    ...
    def fit(self, C=1, max_iter=1000, strategy='ovo', solver='liblinear'):
...
if __name__ == '__main__':
    ...
    classifier = logistic_regression_classifier(data_file='RD_1XST.csv')
    classifier.fit(strategy='ovr', solver='liblinear')
    classifier.plot(2,0)
    # for file in files:
    #     classifier = logistic_regression_classifier(data_file=file, features_degree=2)
    #     classifier.fit()
