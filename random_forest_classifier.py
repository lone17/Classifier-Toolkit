...
class random_forest_classifier(object):
    ...
    def fit(self, num_trees=30, criterion='entropy', min_samples_split=5, min_impurity_decrease=0.00005):
...
if __name__ == '__main__':
    ...
    train_files = ["RD_2P_P.csv", "RD_2X.csv", "RD_3P.csv", "RD_4P.csv",
                   "RD_5P.csv", "RD_6P_P.csv", "RD_7P.csv",
                   "RDT_1RX.csv", "RDT_1P.csv", "RDT_2P.csv"];
    val_files = ["RD_1XST.csv", "RD-1P.csv", "RD_8P.csv"]
    ...
    classifier = random_forest_classifier(data_file="RD-RDT DATA ALL.csv",
    ...
    # for file in files:
    #     classifier = random_forest_classifier(data_file=file)
    #     classifier.fit()
